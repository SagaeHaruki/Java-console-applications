...
public class MyClass {
   public static void main(String[] args) {
      ...
      System.out.print("Now Enter your Birth Month in this format [MONTH/DD/YYYY] separated by space: \n");
      System.out.print(">> ");
      String myBM = Scan.nextLine();
      String dat[] = myBM.split(" ", 2);
      String dat1 = dat[0];
      String dat2 = dat[1];
      System.out.print("Your Birth month is on " + dat1 + " " + dat2 + "\n");
      Self.add(dat1);
      System.out.print("---------------------------------------------------\n");
      ...
      if (Groupe1.containsAll(Self) || Groupe2.containsAll(Self)) {
         System.out.print("Your Classmate(s) with Birth month of " + dat1 + " the same as you! \n");

         Group1.keySet().removeAll(
               Group1.entrySet().stream()
                     .filter(a -> !a.getValue().equals(dat1))
